...
$pageTitle='My Profile'; $activeRole='housekeeping'; $activePage='profile';
...
<main class="main-content">
  ...
  <div class="card" style="max-width:500px">
    <form method="POST" action="<?= BASE_URL ?>/housekeeping/controllers/housekeeping_controller.php">
      ...
      <div class="form-group"><label class="form-label">Role</label><input class="form-control" value="Housekeeping Supervisor" disabled></div>
